...
with tab2:
    ...
    if search_button:
        ...
        try :
            ...
            Taux de rendement de : {tx_rendement}, Rendement de {rendement}  
            Taux de Rentabilité de : {tx_rentabilite}, Rentabilité de {rentabilite}  
            Intervalle de confiance de rentabilité : [{renta_lower} : {renta_upper}]')
        except:
